...
test('preview components enforce iframe, source-window, protocol, and timeout boundaries', () => {
  const previewPath = join(root, 'src/components/playground/SandboxedPreview.jsx');
  ...
  const documents = readFileSync(join(root, 'src/components/playground/documents.js'), 'utf8');
